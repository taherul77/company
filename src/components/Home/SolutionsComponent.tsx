  ...
  return (
    <div className="container  flex justify-center ">
      <div className="h-[36rem] w-96 relative my-10 hidden lg:flex">
        <div className="relative9 relative">
          <div className="absolute top-0 left-0 duration-500 hover:z-40">
            <div className="hover-trigger absolute top-[490px] left-[27rem]">
              <h3 className="text-2xl font-bold text-container">University</h3>
        ...
        <div className="relative8">
          <div className="absolute top-0 duration-500 hover:z-40">
            <div className="hover-trigger absolute top-[27rem] -left-[22rem] ">
        ...
        <div className="relative7">
          <div className="absolute top-0 left-0  duration-500 hover:z-40">
            <div className="hover-trigger absolute top-[338px] -left-[25rem] ">
              <h3 className="text-2xl font-bold text-container">
                Medical College
              </h3>
              <h3 className="text-2xl font-bold text-container">
        ...
        <div className="relative6">
          <div className="absolute top-0 z-10 left-0  duration-500 hover:z-40">
            <div className="hover-trigger absolute top-60 left-[35rem] ">
              <h3 className="text-2xl font-bold text-container">
                Vat Automatic
              </h3>
            </div>
        ...
        <div className="relative5">
          <div className="absolute top-0 z-10 left-0 hover:h-48 hover:w-48 hover:inset-0 duration-500 hover:z-40">
            <div className="hover-trigger absolute top-[284px] left-[29rem] ">
        ...
        <div className="relative4">
          <div className="absolute top-0 left-0 z-10 duration-500">
            <div className="hover-trigger absolute -top-1 -left-80">
              <h2 className="text-2xl font-bold text-container">Laboratory</h2>
        ...
        <div className="relative3">
          <div className="absolute top-0 left-0  duration-500 hover:z-40">
            <div className="hover-trigger absolute top-[76px] -left-[26rem] ">
              <h3 className="text-2xl font-bold text-container">Enterprise</h3>
              <h3 className="text-2xl font-bold text-container">
                Resource Planning
              </h3>
            </div>
        ...
        <div className="relative2">
          <div className="absolute top-0 left-0  duration-500 hover:z-40">
            <div className="hover-trigger absolute top-20 left-[36rem] ">
        ...
        <div className="relative1">
          <div className="absolute top-0 left-0 duration-500 hover:z-40">
            <div className="hover-trigger absolute -top-28 left-[23rem] ">
              <h3 className="text-2xl font-bold text-container">
                Human Resource
              </h3>
              <h3 className="text-2xl font-bold text-container">
