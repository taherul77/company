  ...
  return (
    <>
      <div className="container flex flex-col items-center mx-auto ">
        <div
          className="flex flex-col w-full divide-y sm:flex-row sm:divide-y-0 sm:divide-x
          ...
          <div className="flex flex-col justify-center w-full divide-y ">
            <div className="flex flex-col w-full justify-center items-center text-center  text-white font-bold py-8">
              <Image
                ...
                src={image}
              />
              <h5 className="text-xl uppercase py-2">Leadership</h5>
            </div>
          </div>
          <div className="flex flex-col justify-center w-full divide-y ">
            <div className="flex flex-col w-full justify-center items-center text-center text-white font-bold py-8">
              <Image
                ...
                src={image2}
              />
              <h5 className="text-xl uppercase py-2">Progression</h5>
            </div>
          </div>
          <div className="flex flex-col justify-center w-full divide-y ">
            <div className="flex flex-col w-full justify-center items-center text-center text-white font-bold py-8">
              <Image
                ...
                src={image1}
              />
              <h5 className="text-xl uppercase py-2">Execution</h5>
            </div>
          </div>
          <div className="flex flex-col justify-center w-full divide-y ">
            <div className="flex flex-col w-full justify-center items-center text-center text-white font-bold py-8">
              <Image
                ...
                src={image3}
              />
              <h5 className="text-xl uppercase py-2">Results</h5>
            </div>
          </div>
        </div>
      </div>
